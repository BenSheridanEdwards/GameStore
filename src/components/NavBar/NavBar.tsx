    ...
    <div className="mx-auto flex h-full w-full max-w-screen-2xl items-center px-6">
      <nav className="mr-8 flex w-full justify-between">
        <div className="m-w-[240px] flex flex-col pr-8">
          <h1 className="text-2xl font-bold text-light">{headerText}</h1>
        ...
        <Link
          leadingIcon={
            <div className="relative mr-4">
              ...
              <span className="absolute right-[-50%] top-[-50%] h-[24px] w-[24px] rounded-xl bg-accent text-center font-bold leading-6 text-dark">
